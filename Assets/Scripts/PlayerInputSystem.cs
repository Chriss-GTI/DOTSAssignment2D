...
[UpdateInGroup(typeof(InitializationSystemGroup), OrderLast = true)] //means that we want this to run before anything else runs like game logic
public partial class PlayerInputSystem : SystemBase
{
    ...
    protected override void OnCreate() //forced the update loop to wait when:
    {
